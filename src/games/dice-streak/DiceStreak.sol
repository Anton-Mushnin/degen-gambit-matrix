...
import "../../contracts/CommitRevealRandomness.sol";
...
contract DiceStreak is CommitRevealRandomness {
    ...
    function _checkStreakCombo(address player) internal view returns (bool hasCombo, uint256 bonusPayout, string memory comboType) {
