...
- **Output Pattern**: 
  - Success: "Bet committed: ODD ([amount] WEI). Auto-reveal in 1 block."
...
- **Output Pattern**: 
  - Success: "Bet committed: EVEN ([amount] WEI). Auto-reveal in 1 block."
  - Already Pending: "You have a pending bet. Wait for auto-reveal."
...
### auto-reveal
- **Trigger**: Called automatically after 1 blocks from bet commit
- **Delay**: 3 blocks
- **Output Pattern**: 
...
- **Output Pattern**: 
  - Success: "FREE SPIN bet committed: [CHOICE] (0 WEI). Auto-reveal in 1 blocks."
