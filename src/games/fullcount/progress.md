...
- [x] Step 1: Verified game name uniqueness and created `src/games/fullcount` with this progress tracker.
- [x] Step 2: Derived and drafted `design/rules.md` from `contract/data.sol` and `contract/Fullcount.sol`.
